...
- Bundle root: `docs/plan-goals/06-rival-viability`
- Source of truth: `docs/plan-goals/06-rival-viability/PLAN.md`
- Launcher: `docs/plan-goals/06-rival-viability/LAUNCHER.txt`
- Progress ledger: `docs/plan-goals/06-rival-viability/progress.jsonl`
- Goal outcome: `docs/plan-goals/06-rival-viability/GOAL_OUTCOME.md`
- Evidence directory: `docs/plan-goals/06-rival-viability/evidence/`
- Notes directory: `docs/plan-goals/06-rival-viability/notes/`
